...
import static com.example.demo.spring.domain.product.ProductSellingStatus.SELLING;
import static com.example.demo.spring.domain.product.ProductType.HANDMADE;
...
//    }
    ...
    void sendOrderStatisticsMail() {
        ...
        Order order1 = createPaymentCompletedOrder(LocalDateTime.of(2024, 10, 22, 23, 59, 59), products);
        Order order2 = createPaymentCompletedOrder(now, products);
        Order order3 = createPaymentCompletedOrder(LocalDateTime.of(2024, 10, 23, 23, 59, 59), products);
        Order order4 = createPaymentCompletedOrder(LocalDateTime.of(2024, 10, 24, 0, 0), products);
